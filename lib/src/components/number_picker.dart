...
class NumberPicker extends StatelessWidget {
  ...
  NumberPicker.horizontal({
    ...
    this.decoration,
        ...
        decimalPlaces = 0,
        intScrollController = InfiniteScrollController(
  ...
  NumberPicker.decimal({
    ...
    this.decoration,
        ...
        decimalScrollController = InfiniteScrollController(
  ...
  final InfiniteScrollController intScrollController;

  ///ScrollController used for decimal list
  final InfiniteScrollController decimalScrollController;
  ...
  Listener _integerListView(ThemeData themeData) {
    final TextStyle defaultStyle = Styles.textLight;
    final TextStyle selectedStyle = Styles.numberPickerHeading;
  ...
  Listener _decimalListView(ThemeData themeData) {
    final TextStyle defaultStyle = themeData.textTheme.body1;
    final TextStyle selectedStyle = Styles.numberPickerHeading;

    final int decimalItemCount =
            ...
            children: <Widget>[
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  final bool isExtra =
                      index == 0 || index == decimalItemCount - 1;
  ...
  Listener _integerInfiniteListView(ThemeData themeData) {
    final TextStyle defaultStyle = themeData.textTheme.body1;
    final TextStyle selectedStyle = Styles.numberPickerHeading;
    ...
    if (notification is ScrollNotification) {
      ...
      if (!infiniteLoop) {
        intIndexOfMiddleElement =
            intIndexOfMiddleElement.clamp(0, integerItemCount - 1).toInt();
      }
  ...
  bool _onDecimalNotification(Notification notification) {
    if (notification is ScrollNotification) {
      ...
      final int indexOfMiddleElement =
      ...
      if (selectedIntValue != maxValue &&
        ...
        final double newValue = (selectedIntValue + decimalPart).toDouble();
        onChanged(newValue);
      }
    }
    return true;
  ...
  int _normalizeDecimalMiddleValue(int decimalValueInTheMiddle) {
    return _normalizeMiddleValue(
        decimalValueInTheMiddle, 0, math.pow(10, decimalPlaces - 1).toInt());
  }
